...
export class DashboardComponent implements OnInit {
  ...
  recentProjectNoData: boolean = false;
  dashboardCountNoData: boolean = false;
  dashboardPendingCheckData: boolean = false;
  monthArray = [
  ...
  dashboardPendingCheckList() {
    ...
    this.adminLayoutService.getDashboardPendingCheckInList().subscribe((Response: any) => {
      if (Response.meta.code == 200) {
        ...
        this.dashboardPendingCheckLists = data.sort((a: any, b: any) => {
    ...
    this.adminLayoutService.getDashboardLeaveCountList().subscribe((Response: any) => {
      if (Response.meta.code == 200) {
        ...
        for (let i = 0; i < 12; i++) {
          ...
          let responseData = Response.data.filter((y: any, index: any) => y.monthNumber == i + 1)
...
function sortData(a: number, b: number) {
