...
import { CountryStateCityService } from '../../../../layout/admin-layout/country-state-city.service';
declare const $: any;
...
export class CompanyMasterComponent implements OnInit {
  ...
  hideDocBankDetails: boolean = false;
  ...
  constructor(private http: HttpClient, private service: CountryStateCityService, private fb: FormBuilder, public storageService: StorageService, private route: ActivatedRoute, private router: Router, public commonService: CommonService, public adminLayoutService: AdminLayoutService) {
  ...
  getDocumentMasterList() {
    ...
    this.adminLayoutService.getDocumentMasterActiveList().subscribe((Response: any) => {
  ...
  openDocumentMasterModal() {
    ...
    $("#add-document-master-modal").modal({ backdrop: 'static', keyboard: false, });
    $("#add-document-master-modal").modal("show");
  }
  ...
  saveDocumentMasterData() {
    ...
    this.adminLayoutService.SavedocumentMasterDetails(documentMasterDataObj).subscribe((Res: any) => {
      if (Res.meta.code == 200) {
        this.submittedDocumentMasterData = false;
        this.defualtDocumentMasterForm();
        this.docError = false;
  ...
  updateDocumentMasterData() {
    ...
    this.adminLayoutService.updateDocumentMasterDetails(documentMasterDataObj).subscribe((Res: any) => {
      if (Res.meta.code == 200) {
        this.submittedDocumentMasterData = false;
        this.defualtDocumentMasterForm();
        this.docError = false;
  ...
  getDocumentMasterById(id: any) {
    let companyObj = {
      _id: id
    }
    this.adminLayoutService.getDocumentMasterByID(companyObj).subscribe((Res: any) => {
      if (Res.meta.code == 200) {
  ...
  getDocumentMasterListByCompanyId() {
    ...
    this.adminLayoutService.getDocumentMasterList(companyDocumentMasterObj).subscribe((Response: any) => {
      if (Response.meta.code == 200) {
  ...
  openBankDetails() {
    ...
    $("#add-bank-details-modal").modal({ backdrop: 'static', keyboard: false, });
    $("#add-bank-details-modal").modal("show");
  }
  cancelBankDetails() {
    this.defualtDocumentMasterForm();
    this.submittedDocumentMasterData = false;
  ...
  saveBankDetails() {
    ...
    this.adminLayoutService.SaveBankDetails(bankDetailsObj).subscribe((Res: any) => {
      if (Res.meta.code == 200) {
        this.defualtBankDetailsForm();
        this.submittedBankDetailsData = false;
        this.IsEditBankDetails = false;
  ...
  updateBankDetails() {
    ...
    this.adminLayoutService.updateBankDetails(bankDetailsObj).subscribe((Res: any) => {
      if (Res.meta.code == 200) {
        this.defualtBankDetailsForm();
        this.submittedBankDetailsData = false;
        this.IsEditBankDetails = false;
  ...
  getBankDetailsByID(id: any) {
    ...
    this.adminLayoutService.getBankDetailsByID(Obj).subscribe((Res: any) => {
      if (Res.meta.code == 200) {
  ...
  deleteBankDetailsById(id: any) {
    let Obj = {
      bankDetailsId: id
    }
    this.adminLayoutService.getBankDeleteDetailsByID(Obj).subscribe((Res: any) => {
      if (Res.meta.code == 200) {
        this.getBankDetailsList();
      }
    })
  ...
  getBankDetailsList() {
    ...
    this.adminLayoutService.getBankDetailsList(Obj).subscribe((Res: any) => {
      if (Res.meta.code == 200) {
